...
$noticeText = "";
$conn = new mysqli("localhost", "root", "", "ded2");

if (!$conn->connect_error) {
    $result = $conn->query("SELECT message FROM notices WHERE status = 'active' ORDER BY created_at DESC");

    while ($row = $result->fetch_assoc()) {
        $noticeText .= htmlspecialchars($row['message']) . " &nbsp;&nbsp;|&nbsp;&nbsp; ";
    }
...
<!-- ✅ Dynamic Scrolling Notice Dashboard -->
<div class="notice-dashboard">
  <div class="notice-track">
    <span class="notice-text"><?= $noticeText ?: 'No active notices available.' ?></span>
  </div>
</div>
...
<main style="position: relative;">
  <section class="hero">
    ...
    <a href="schedule.html" class="cta-button">Book your slot</a>
  </section>
...
<div id="schedule-modal" class="modal">
  <div class="modal-content">
    <span class="close-btn" onclick="closeSchedulePopup()">&times;</span>
